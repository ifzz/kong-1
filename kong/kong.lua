...
function Kong.serve_admin_api(options)
  ...
  if not constants.ADMIN_API.ALLOWED_METHODS[ngx.req.get_method()] then
    header["Access-Control-Allow-Methods"] = table.concat(constants.ADMIN_API.ALLOWED_METHODS, ", ")
